...
describe('Bitmap Parser', function() {
  describe('bitmapParser(bitmapFile)', function() {
    ...
    describe(('When passed a ' + bitmapOneReference + '...'), function() {
      describe(('The bitmap parser should return an object with the header information that...'), function() {
        var bitmap = null;
        before(function(done) {
          fs.readFile(bitmapOneForTests, function(err, data) {
            if(err) throw err;
            bitmap = bitmapParser(data);
            done();
          });
        });
        ...
        describe(('When the bitmap has a "BITMAPINFOHEADER" DIB header the returned object also...'), function() {
          ...
          describe(('If the color palette has colors...'), function() {
          ...
          describe(('If the image has pixels...'), function() {
    ...
    describe(('When passed a ' + bitmapTwoReference + '...'), function() {
      describe(('The bitmap parser should return an object with the header information that...'), function() {
        var bitmap = null;
        before(function(done) {
    ...
    describe(('When passed a ' + bitmapThreeReference + '...'), function() {
      describe(('The bitmap parser should return an object with the header information that...'), function() {
        var bitmap = null;
        before(function(done) {
        ...
        describe(('When the bitmap has a "BITMAPV4HEADER" DIB header the returned object also...'), function() {
          it('Should have a property containing the bitmap\'s width (in pixels).', function() {
    ...
    describe(('When passed a ' + bitmapFourReference + '...'), function() {
      describe(('The bitmap parser should return an object with the header information that...'), function() {
        var bitmap = null;
        before(function(done) {
